...
class ChineseCheckersBoard(AECEnv):
    def __init__(self, numPlayers, env_config=None):
        super().__init__()
        ...
        self.PlayerPOVPosition = {2: [3,3], 3: [2,2,3], 4: [1,2,1,2], 6: [1,1,1,1,1,1]}.get(numPlayers) #CCW
        ...
        self.agents = self.possible_agents = ["player_" + str(r) for r in range(1,numPlayers+1)]
